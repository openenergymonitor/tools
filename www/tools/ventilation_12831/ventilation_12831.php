...
<div class="container mt-3" style="max-width:800px" id="app">
    <div class="row">
        <div class="col">
            ...
            <p>See source code for a reference implementation of the EN12831 ventilation calculation. Example given below has also been validated to give the same result as the MCS heat load calculator.</p>
